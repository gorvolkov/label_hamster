# Здесь получаем баркоды по EAN

# 1. Идём в xls_files, вынимаем EAN
# 2. Обращаемся по API к сервису генерации баркодов, получаем баркоды
# 3. Сохраняем баркоды в папку barcodes в нужном формате (?)
